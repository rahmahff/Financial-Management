          ...
          <div class="form-container">
            ...
            <form action="create_income.php" method="POST">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="income_name" name="income_name" placeholder="Enter Income Name" required>
              </div>
              <div class="form-group">
                  <label for="income_amount">Amount</label>
                  <input type="number" class="form-control" id="income_amount" name="income_amount" placeholder="Enter Income Amount" required>
              </div>
              <div class="form-group">
