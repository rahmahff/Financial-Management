      ...
      <div class="card">
        <div class="card-body row">
          <div class="col-5 text-center d-flex align-items-center justify-content-center">
            <div class="">
              <h2>Manage</h2>
              <h1><strong>Your Income</strong></h1>
              <h4>Here!</h4>
            </div>
          </div>
          <div class="col-7">
            <div class="form-group d-flex flex-column" style="margin-top: 25px;">
              <a href="create_income.php" class="btn btn-outline-dark mb-2">Create Income</a>
              <a href="view_income.php" class="btn btn-outline-dark mb-2">View Income</a>
            </div>
          </div>                    
        </div>
      </div>
